...
from baselines.pois1 import pois1
from baselines.pois1.parallel_sampler import ParallelSampler
...
def train(env, max_iters, num_episodes, horizon, iw_method, iw_norm, natural, bound, delta, gamma, seed, policy, max_offline_iters, njobs=1):
    ...
    pois1.learn(make_env, make_policy, sampler=sampler, n_episodes=num_episodes, max_iters=500,
